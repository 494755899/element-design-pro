<template>
  <div class="element-pro-layout-aside">
    <el-menu
      ...
      :class="[
        'element-pro-layout-menu-verical',
        navTheme === 'dark' ? 'el-menu-dark-navTheme':'el-menu-light-navTheme'
      ]"
      :collapse="isCollapse">
...
// .element-pro-layout-aside {
  ...
  // 暗色系样式
  .el-menu-dark-navTheme, .el-menu-dark--vertical {
    // 暗色系的样式
    .element-pro-layout-logo {
      background: #002140;
      h1 {
