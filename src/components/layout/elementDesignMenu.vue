<template>
  <div class="element-pro-layout-aside">
    <el-menu
      :backgroundColor="navTheme === 'dark' ? '#001529' : ''"
      :textColor="navTheme === 'dark' ? 'rgba(255, 255, 255, 0.65)' : ''"
      :activeTextColor="navTheme === 'dark' ? '#ffffff':''"
      :default-active="defaultActive"
      router
      class='element-pro-layout-menu-verical'
      :collapse="isCollapse">
      <div class="element-pro-layout-logo" id="logo">
        <a href="/">
